...
class ViewController: UIViewController, ParticleLabDelegate
{
    ...
    override func viewDidLoad()
    {
        ...
        menuButton.addTarget(self, action: #selector(ViewController.displayCallout), for: UIControl.Event.touchDown)
    ...
    @objc func displayCallout()
    {
        ...
        let cloudChamberAction = UIAlertAction(title: DemoModes.cloudChamber.rawValue, style: UIAlertAction.Style.default, handler: calloutActionHandler)
        let orbitsAction = UIAlertAction(title: DemoModes.orbits.rawValue, style: UIAlertAction.Style.default, handler: calloutActionHandler)
        ...
        let respawnAction = UIAlertAction(title: DemoModes.respawn.rawValue, style: UIAlertAction.Style.default, handler: calloutActionHandler)
        let iPadProAction = UIAlertAction(title: DemoModes.iPadProDemo.rawValue, style: UIAlertAction.Style.default, handler: calloutActionHandler)
